                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header" style="border-bottom:none;">
                              <h2 class="col-md-6" style="padding:0px;">Packages List</h2>
                              <div class="col-md-6" style="padding:0px; text-align:right;">
                                ...
                                <a href="<?php echo site_url('admin/packages/package_add') ?>" data-toggle="tooltip" title="Add New Record" class="btn btn-success btn-background"><i class="glyphicon glyphicon-plus"></i></a>
                              </div>
                            </div>
                            <div class="body">
                            <div class="table-responsive">
                              <table id="dataManual" class="table table-bordered table-striped" style="width:100%;">
                                    ...
                                    <th title="Inclusion"> Inclusion </th>
                                    <th title="Water Sports"> Water Sports </th>
        ...
        <script type="text/javascript">
          $(function () {
            $('#dataManual').DataTable({
              "bServerSide": true,
              "sAjaxSource": "<?php echo site_url('admin/packages/packages_list'); ?>",
              "sServerMethod": "POST",
