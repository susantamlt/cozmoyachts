                            ...
                            <div class="body">
                                <?php echo form_open_multipart('admin/bookings/bookings_save', array('id' =>'bookings_form','name'=>'bookings_form','class'=>'form-horizontal','enctype'=>'multipart/form-data','method'=>'POST')); ?>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group input-group-lg">
                                                <span class="input-group-addon1">
                                                    <input class="form-control new_exsting" id="new_exsting1" name="new_exsting" type="radio" value="1" <?php if($ljp_Data[0]['user_id'] < 1){ echo 'checked="checked"'; }?> />
                                                    <label for="new_exsting1">New</label>
                                                </span>
                                                <span class="input-group-addon1">
                                                    <input class="form-control new_exsting" id="new_exsting2" name="new_exsting" type="radio" value="2" <?php if($ljp_Data[0]['user_id'] > 0){ echo 'checked="checked"';} ?> />
                                        ...
                                        <div class="col-md-4">
                                            <div id="newemailid">
                                                <?php if($ljp_Data[0]['user_id']>0){ ?>
                                                    <?php echo form_dropdown('emailid',$cy_user,$ljp_Data[0]['user_id'],'class="form-control show-tick" id="emailid"') ?>
                                                <?php }  else { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group input-group-lg">
                                                <span class="input-group-addon1">
                                                    <input class="form-control new_exstingL" id="new_exstingL1" name="new_exstingL" type="radio" value="1" <?php if($ljp_Data[0]['lead_id']<1){ echo 'checked="checked"';} ?> />
                                                    <label for="new_exstingL1">New</label>
                                                </span>
                                                <span class="input-group-addon1">
                                                    <input class="form-control new_exstingL" id="new_exstingL2" name="new_exstingL" type="radio" value="2" <?php if($ljp_Data[0]['lead_id']>0){ echo 'checked="checked"';} ?> />
                                        ...
                                        <div class="col-md-4">
                                            <div id="newleadid">
                                                <?php if($ljp_Data[0]['lead_id']>0){ ?>
                                                    <?php echo form_dropdown('leadid',$cy_lead,$ljp_Data[0]['lead_id'],'class="form-control show-tick" id="leadid"') ?>
                                                <?php }  else { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <?php echo form_dropdown('web_id',$cy_website,$ljp_Data[0]['web_id'],'class="form-control show-tick" id="web_id"') ?>
                                            <label id="web_id-error" class="error" for="web_id"></label>
                                        </div>
                                        <label class="col-md-2"> Package / Yacht  Name: </label>
                                        <div class="col-md-4">
                                            <?php echo form_dropdown('pak_id',$cy_package,$ljp_Data[0]['pak_id'],'class="form-control show-tick" id="pak_id"') ?>
                                    ...
                                    <div class="form-group demo-masked-input">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                <div class="form-line">
                                                    <input type="text"  name="book_date" id="book_date" class="form-control date" placeholder="Ex: 07/30/2016" value="<?php echo $ljp_Data[0]['book_date']; ?>">
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group demo-masked-input">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                <div class="form-line">
                                                    <input name="book_time" id="book_time" type="text" class="form-control time12" placeholder="Ex: 11:59 pm" value="<?php echo $ljp_Data[0]['book_time']; ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="durations" id="durations" class="form-control" placeholder="Durations" value="<?php echo $ljp_Data[0]['durations']; ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="discount" id="discount" class="form-control" placeholder="Discount" value="<?php echo $ljp_Data[0]['discount']; ?>" />
                                            <label id="discount-error" class="error" for="discount"></label>
                                        </div>
                                        <label class="col-md-2"> Exclusive Facilities Amount: </label>
                                        <div class="col-md-4">
                                            <input type="text" name="amount" id="amount" class="form-control" value="<?php echo $ljp_Data[0]['amount']; ?>" placeholder="Exclusive Facilities Amount" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="sub_total" id="sub_total" class="form-control" value="<?php echo $ljp_Data[0]['sub_total']; ?>" placeholder="Sub Total" />
                                            <label id="sub_total-error" class="error" for="sub_total"></label>
                                        </div>
                                        <label class="col-md-2"> Total Amount: </label>
                                        <div class="col-md-4">
                                            <input type="text" name="total_amount" id="total_amount" class="form-control" value="<?php echo $ljp_Data[0]['total_amount']; ?>" placeholder="Total Amount" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <textarea name="address" id="address" class="form-control" placeholder="Address" /><?php echo $ljp_Data[0]['address']; ?></textarea>
                                        ...
                                        <div class="col-md-4">
                                            <select name="payment_method" id="payment_method" class="form-control" title="Payment Method">
                                                <option value="" <?php if($ljp_Data[0]['payment_method']==''){ echo 'selected="selected"';} ?>>--Select One--</option>
                                                <option value="cash" <?php if($ljp_Data[0]['payment_method']=='cash'){ echo 'selected="selected"';} ?>>Cash</option>
                                                <option value="stripe" <?php if($ljp_Data[0]['payment_method']=='stripe'){ echo 'selected="selected"';} ?>>Stripe</option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="payment_metpayment_statushod" id="payment_status" class="form-control" title="Payment Method">
                                                <option value="" <?php if($ljp_Data[0]['payment_status']==''){ echo 'selected="selected"';} ?>>--Select One--</option>
                                                <option value="1" <?php if($ljp_Data[0]['payment_status']=='1'){ echo 'selected="selected"';} ?>>Unpaid</option>
                                                <option value="2" <?php if($ljp_Data[0]['payment_status']=='2'){ echo 'selected="selected"';} ?>>Pay 100%</option>
                                                <option value="3" <?php if($ljp_Data[0]['payment_status']=='3'){ echo 'selected="selected"';} ?>>Pay 20%</option>
                                                <option value="4" <?php if($ljp_Data[0]['payment_status']=='4'){ echo 'selected="selected"';} ?>>Refund</option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input type="hidden" name="booking_id" id="booking_id" value="<?php echo $ljp_Data[0]['booking_id']; ?>">
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            if(resD.status=='1'){
                                ...
                                $('#book_date').attr('value',vdata.date_of_trip);
                                $('#book_time').attr('value',data.time_of_trip);
                            } else {
