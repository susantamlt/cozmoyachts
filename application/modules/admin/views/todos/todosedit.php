						...
						<div class="card">
							...
							<div class="body">
								...
								<div class="form-group demo-masked-input">
										...
										<div class="col-md-4">
											<input type="text" name="notification_date" id="notification_date" class="form-control date" 
											value="<?php echo date('m/d/Y', strtotime($ljp_Data[0]['notification_date']))?>" placeholder="mm/dd/yyyy	" autocomplete="off" />
										...
										<div class="col-md-4">
											<select name="status" id="status" class="form-control">
												<option value="" <?php if($ljp_Data[0]['status']==''){ echo 'selected="selected"'; } ?>>--Select One--</option>
												<option value="0" <?php if($ljp_Data[0]['status']==0){ echo 'selected="selected"'; } ?>>Read</option>
												<option value="1" <?php if($ljp_Data[0]['status']==1){ echo 'selected="selected"'; } ?>>Unead</option>
											</select> 
									...
									<div class="form-group demo-masked-input">
										...
										<div class="col-md-4">
											<input type="text" name="todo_time" id="todo_time" class="form-control time12" value="<?php echo $ljp_Data[0]['todo_time']; ?>" placeholder="hh:mm" />
										...
										<div class="col-md-12">
											<textarea name="msg" id="msg" class="form-control" placeholder="Message details"><?php echo $ljp_Data[0]['msg']; ?></textarea>
											<label id="msg-error" class="error" for="msg"></label>
										</div>
									</div>
                                    <div class="form-group">
										<div class="col-md-12">
											<input type="hidden" name="todo_id" id="todo_id" value="<?php echo $ljp_Data[0]['todo_id']; ?>">
					...
					$.ajax({
							...
							success: function(res) {
								...
								if(resD.status=='1'){
									...
									var html = '<div class="alert alert-warning fade in alert-dismissible" style="margin-top:18px;"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a><strong>Warning!</strong> Update fail.</div>';
									$('#massage').html(html);
								}
							}
						});
