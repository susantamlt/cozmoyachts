                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header" style="border-bottom:none;">
                              <h2 class="col-md-6" style="padding:0px;">Customers List</h2>
                              <div class="col-md-6" style="padding:0px; text-align:right;">
                                ...
                                <a href="<?php echo site_url('admin/customers/customer_add') ?>" data-toggle="tooltip" title="Add New Record" class="btn btn-success btn-background"><i class="glyphicon glyphicon-plus"></i></a>
                                <a href="<?php echo site_url('admin/customers/customersimport') ?>" data-toggle="tooltip" title="Import Leads" class="btn btn-success btn-background"><i class="glyphicon glyphicon-import"></i></a>
                              </div>
                            </div>
                            <div class="body">
        ...
        <script type="text/javascript">
          $(function () {
            $('#dataManual').DataTable({
              "bServerSide": true,
              "sAjaxSource": "<?php echo site_url('admin/customers/customers_list'); ?>",
              "sServerMethod": "POST",
