				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="card">
							...
							<div class="body">
								<?php echo form_open_multipart('admin/deals/deals_save', array('id' =>'packages_form','name'=>'deals_form','class'=>'form-horizontal','enctype'=>'multipart/form-data','method'=>'POST')); ?>
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="package_name" id="package_name" class="form-control" value="" placeholder="Deal name" />
                                    ...
                                    <div class="form-group">
										<div class="col-md-12">
											<input type="hidden" name="type" id="type" value="Deals">
