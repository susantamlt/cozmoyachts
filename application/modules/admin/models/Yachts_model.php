<?php class Yachts_model extends CI_Model
{
	function __construct() {
		parent::__construct();
	}

	public function get_yachts_list($date='') {
		$tableName = 'package';
		$tableName1 = 'website';
		$tableName2 = 'users';
		$columns   = array(
		...
		$condition   = "WHERE $tableName.pak_status!='' AND $tableName.type='Yacht'";
	...
	public function yachts_save($date='') {
		$id = 0;
