    ...
    <body class="theme-red">
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url('users'); ?>">Cozmo Yachts</a>
                </div>
        ...
        <section>
            ...
            <aside id="leftsidebar" class="sidebar">
                ...
                <div class="user-info">
                    <div class="image">
                        <img src="<?php echo config_item('assets_dir');?>users/user/user.png" width="48" height="48" alt="User" />
                    </div>
                    <div class="info-container">
                        ...
                        <div class="btn-group user-helper-dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li role="seperator" class="divider"></li>
                                <li><a href="<?php echo base_url('login/user_logout'); ?>"><i class="material-icons">input</i>Sign Out</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
