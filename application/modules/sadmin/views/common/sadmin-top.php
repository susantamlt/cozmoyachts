...
<html>
    <head>
        ...
        <title>Super Admin | Cozmo Yachts</title>
        <!-- Favicon-->
    ...
    <body class="theme-red">
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url('sadmin'); ?>">Cozmo Yachts</a>
                </div>
        ...
        <section>
            ...
            <aside id="leftsidebar" class="sidebar">
                ...
                <div class="user-info">
                    <div class="image">
                        <img src="<?php echo config_item('assets_dir');?>users/sadmin/user.png" width="48" height="48" alt="User" />
                    </div>
                    <div class="info-container">
                        <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $this->session->userdata('sadmin_user_name') ?></div>
                        <div class="email"><?php echo $this->session->userdata('sadmin_email'); ?></div>
                        <div class="btn-group user-helper-dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li role="seperator" class="divider"></li>
                                <li><a href="<?php echo base_url('login/sadmin_logout'); ?>"><i class="material-icons">input</i>Sign Out</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
